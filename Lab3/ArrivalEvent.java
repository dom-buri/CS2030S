...
class ArrivalEvent extends Event {
  ...
  public String toString() {
    return String.format(super.toString() + ": %s arrived %s", this.customer, this.shop);
  }
  ...
  public Event[] simulate() {
    ...
    if (counter == null) {
      Counter shortestCounter = shop.getShortestCounterQueue();
      if (shop.getQueue().isFull() && shortestCounter == null) {
        return new Event[] {
        ...
        if (shortestCounter == null) {
          return new Event[] {
            new EntranceQueueEvent(this.getTime(), this.customer, this.shop)
          };
        } else {
          return new Event[] {
            new CounterQueueEvent(this.getTime(), this.customer, shortestCounter)
          };
        }
      }
    } else {
