...
class ServiceBeginEvent extends Event {
  ...
  public String toString() {
    return String.format(super.toString() + ": %s service begin (by %s)", 
  ...
  public Event[] simulate() {
    ...
    return new Event[] {
        new ServiceEndEvent(this.customer.calculateEndTime(
                            this.getTime()), this.customer, this.counter, this.shop)
    };
  }
}
